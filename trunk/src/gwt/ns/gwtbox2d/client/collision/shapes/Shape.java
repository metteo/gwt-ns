...
import gwt.ns.gwtbox2d.client.collision.PairManager;
...
/**
 * A shape is used for gwt.ns.gwtbox2d.collision detection. Shapes are created in World.
 * You can use shape for gwt.ns.gwtbox2d.collision detection before they are attached to the world.
...
public abstract class Shape {
	...
	/** Set the gwt.ns.gwtbox2d.collision filtering data. */
	public void setFilterData(final FilterData filter){
		m_filter.set(filter);
	}

	/** Get the gwt.ns.gwtbox2d.collision filtering data. */
