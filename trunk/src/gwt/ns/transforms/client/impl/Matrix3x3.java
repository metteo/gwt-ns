...
public class Matrix3x3 {
	 ...
	 * are single threaded. NOTE: rather than call identity() on it every time
	 ...
	 */
	public static final void rotate(Matrix3x3 target, double angle) {
	 ...
	 */
	public static final void skewX(Matrix3x3 target, double angle) {
	 ...
	 * @param angle The angle of the skew.
	 */
	public static final void skewY(Matrix3x3 target, double angle) {
	 ...
	 */
	public static final void copy(Matrix3x3 src, Matrix3x3 dest) {
