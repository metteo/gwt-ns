...
import gwt.ns.gwtbox2d.client.collision.shapes.EdgeChainDef;
import gwt.ns.gwtbox2d.client.collision.shapes.EdgeShape;
import gwt.ns.gwtbox2d.client.collision.shapes.Shape;
import gwt.ns.gwtbox2d.client.collision.shapes.ShapeDef;
...
//		System.out.println("Body hash code: " + this.hashCode());
	...
	/** Is this body treated like a bullet for continuous gwt.ns.gwtbox2d.collision detection? */
	public boolean isBullet(){
		return (m_flags & e_bulletFlag) == e_bulletFlag;
	}

	/**
	 * Should this body be treated like a bullet for continuous gwt.ns.gwtbox2d.collision detection?
	 * Use sparingly, as continuous gwt.ns.gwtbox2d.collision detection can be expensive.
	 */
